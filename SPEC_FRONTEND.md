...
No Web, a compra de pacote do lojista deve exibir opÃ§Ãµes de pagamento apÃ³s selecionar o pacote: `PIX` ativo e `CartÃ£o` visÃ­vel como **em breve** (desabilitado), sem fluxo quebrado.
